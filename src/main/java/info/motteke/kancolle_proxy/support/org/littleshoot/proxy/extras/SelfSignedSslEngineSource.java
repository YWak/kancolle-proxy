package info.motteke.kancolle_proxy.support.org.littleshoot.proxy.extras;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import info.motteke.kancolle_proxy.support.org.littleshoot.proxy.SslEngineSource;
import info.motteke.kancolle_proxy.support.org.littleshoot.proxy.impl.GuavaReplacement;
...
public class SelfSignedSslEngineSource implements SslEngineSource {
    ...
    private String nativeCall(final String... commands) {
        ...
        try {
            ...
            byte[] data = GuavaReplacement.toByteArray(is);
