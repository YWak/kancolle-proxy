...
public class ProxyUtils {
    ...
    public static List<String> getAllCommaSeparatedHeaderValues(String headerName, HttpMessage httpMessage) {
        ...
        GuavaReplacement.ImmutableListBuilder<String> headerValues = new GuavaReplacement.ImmutableListBuilder<>();
    ...
    public static List<String> splitCommaSeparatedHeaderValues(String headerValue) {
        return ImmutableList.<String>copyOf(COMMA_SEPARATED_HEADER_VALUE_SPLITTER.split(headerValue));
    }
