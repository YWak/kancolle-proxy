...
import info.motteke.kancolle_proxy.support.org.littleshoot.proxy.FlowContext;
...
import info.motteke.kancolle_proxy.support.org.littleshoot.proxy.HttpFiltersAdapter;
...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
    ...
    private boolean authenticationRequired(HttpRequest request) {
        ...
        byte[] decodedValue = GuavaReplacement.base64decode(value);
